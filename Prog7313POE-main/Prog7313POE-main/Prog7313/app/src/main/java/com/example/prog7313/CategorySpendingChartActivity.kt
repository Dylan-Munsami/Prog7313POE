...
/**
 * CategorySpendingChartActivity.kt
 *
 * This activity visualizes user spending per category in a bar chart using MPAndroidChart.
 *
 * References and Source Inspiration:
 * - GeeksforGeeks. "How to Create a BarChart in Android?"
 *   URL: https://www.geeksforgeeks.org/how-to-create-a-barchart-in-android/
 * - GeeksforGeeks. "Android | Create BarChart with Kotlin"
 *   URL: https://www.geeksforgeeks.org/android-create-barchart-with-kotlin/
 *
 * Some concepts including MPAndroidChart setup, configuring axes, using BarEntry and BarDataSet,
 * and color customization were referenced from the above tutorials.
 */
