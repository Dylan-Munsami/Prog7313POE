 ...
 *  from https://projectgurukul.org/expense-tracker-android-app-source-code/
 *
 * This class was developed with guidance from the sample app provided by Project Gurukul,
 * especially in areas of Firebase integration and user input handling.
 */
